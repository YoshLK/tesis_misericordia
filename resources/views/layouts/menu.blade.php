...
<li>
        ...
        <a class="{{ Request::is('perosnal/inactivo') ? 'bg-success' : 'bg-white' }}" href="{{ route('personal.inactivo') }}">
            <i class="text-logo fas fa-users-slash"></i><span class="text-logo">Personal Inactivo</span>
            </a>
        </div>
</li>
@endcan
...
<li>
    <a class="nav-link dropdown-toggle text-logo" href="#" id="navbarDropdown3" role="button" data-toggle="dropdown"
        ...
        <a class="{{ Request::is('donador/index') ? 'bg-success' : 'bg-white' }}" href="{{ route('donador.index') }}">
         ...
         <a class="{{ Request::is('donacion/index') ? 'bg-success' : 'bg-white' }}" href="{{ route('donacion.index') }}">
            <i class="text-logo fas fa-boxes"></i><span class="text-logo">Lista Donaciones</span>
        </a>
        @can('auditoria-donacion')
        <a class="{{ Request::is('donaciones/historial') ? 'bg-success' : 'bg-white' }}" href="{{ url('/donaciones/historial')}}">
            <i class="text-logo fas fa-box-open"></i><span class="text-logo">Auditoria Donaciones</span>
        </a>
        @endcan
        </div>  
</li> 
...
<li>
    <a class="nav-link dropdown-toggle text-logo" href="#" id="navbarDropdown4" role="button" data-toggle="dropdown"
            aria-haspopup="true " aria-expanded="false">
            <i class="text-logo fas fa-user-graduate"></i><span class="text-logo">Modulo Universitarios</span>
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown4">
        @can('crear-universitario')
        <a class="{{ Request::is('universitario/create') ? 'bg-success' : 'bg-white' }}" href="{{ route('universitario.create') }}">
            <i class="text-logo fas fa-user-plus"></i><span class="text-logo">Nuevo Universitario</span>
        </a>
        @endcan
        <div class="dropdown-divider"></div>
        <a class="{{ Request::is('universitario') ? 'bg-success' : 'bg-white' }}" href="{{ route('universitario.index') }}">
            <i class="text-logo fas fa-user-friends"></i><span class="text-logo">Lista de Universitarios</span>
        </a>
        <div class="dropdown-divider"></div>
        <a class="{{ Request::is('universitario') ? 'bg-success' : 'bg-white' }}" href="{{ route('universitario.index') }}">
            <i class="text-logo fas fa-users-slash"></i><span class="text-logo">Universitarios Inactivos</span>
        </a>
        </div>  
</li> 
@endcan
...
@can('ver-usuario')
<li>
    <a class="nav-link dropdown-toggle text-logo" href="#" id="navbarDropdown5" role="button" data-toggle="dropdown"
            aria-haspopup="true " aria-expanded="false">
